...
public class JamesHelper {
    ...
    public void createUser(String name, String passwrd) {
        initTelnetSession();
        write("adduser " + name + " " + passwrd);
...
readUntil("Welcome "+login+". HELP for a list of commands");
    ...
    public List<MailMessage> waitForMail(String username, String password, long timeout) throws IOException, javax.mail.MessagingException {
